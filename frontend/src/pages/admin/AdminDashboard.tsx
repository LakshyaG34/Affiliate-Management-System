...
const StatCard = ({ title, value, icon, gradient, subtitle, highlight }: StatCardProps) => (
    <motion.div
        ...
        className={`rounded-2xl shadow-lg border p-6 hover:shadow-xl transition-all duration-300 ${highlight
    ...
    >
        <div className="flex items-start justify-between">
            ...
            <div
                className={`rounded-2xl p-3 shadow-lg flex-shrink-0 ${highlight ? "bg-white/20" : gradient
                    }`}
            >
            ...
            <div className="divide-y divide-gray-50">
                {affiliates.slice(0, 5).map((affiliate, index) => (
                    ...
                    >
                        {/* Rank */}
                        <div
                            className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 ${index === 0
